...
async def get_lol_info(summoner_name, summoner_tag):
    ...
    account_url = f'https://europe.api.riotgames.com/riot/account/v1/accounts/by-riot-id/{url_summoner_name}/{url_summoner_tag}?api_key={TOKEN}'
    ...
    url = f'https://europe.api.riotgames.com/lol/match/v5/matches/by-puuid/{user_puuid}/ids?start=0&count={matchHistoryLength}&api_key={TOKEN}'
    ...
    for match in matchIDList:
        match_url = f'https://europe.api.riotgames.com/lol/match/v5/matches/{match}?api_key={TOKEN}'
